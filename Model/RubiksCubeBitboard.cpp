//
// Created by prath on 03-10-2024.
//
...
public:
    ...
    RubiksCube &b() override {
        this->rotateFace(4);
        uint64_t clr1=(bitboard[0]&(one_8<<(8*2)))>>(one_8>>(8*2));
        uint64_t clr2=(bitboard[0]&(one_8<<(8*1)))>>(one_8>>(8*1));
        uint64_t clr3=(bitboard[0]&(one_8<<(8*0)))>>(one_8>>(8*0));
    ...
    bool operator==(const RubiksCubeBitboard &r1) {
        for(int i=0;i<6;i++) {
